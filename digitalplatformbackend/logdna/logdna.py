...
class MongoHandler(logging.Handler):
    def __init__(self, db_url, db_name, options={}):
        logging.Handler.__init__(self)

        mongo_client = pymongo.MongoClient(db_url)
        self.mongo_database = mongo_client[db_name]
    ...
    def insert_into_mongo(self, data):
        collection = self.mongo_database["logs"]
    ...
    def send_request(self):
        ...
        # self.insert_into_mongo(self.buf)
        pool.submit(self.insert_into_mongo, (self.buf))
        params = {
